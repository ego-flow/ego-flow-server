	...
	return (
		<html lang="en" suppressHydrationWarning>
			...
			<body className="antialiased [overflow-wrap:anywhere]">
				<a
					href="#main-content"
					className="fixed left-4 top-4 z-[100] -translate-y-24 rounded-md bg-primary px-4 py-2 font-semibold text-primary-foreground no-underline transition-transform duration-[var(--motion-fast)] focus:translate-y-0"
				>
					Skip to content
				</a>
