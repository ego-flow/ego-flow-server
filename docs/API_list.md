...
| `GET /api/v1/live-streams/:recordingSessionId` | `recordingSessionId` | live stream detail plus `playback_ready` and nullable HTTP progress | Read one live session detail |
